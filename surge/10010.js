...
===================
[Script]
联通组件 = type=http-request,pattern=https:\/\/m\.client\.10010\.com\/(.*)\/smartwisdomCommon,requires-body=1,max-size=0,script-path=https://cdn.dreamyshare.com/surge/10010.js,script-update-interval=0

===================
【Loon脚本配置】:
===================
[Script]
http-request https:\/\/m\.client\.10010\.com\/(.*)\/smartwisdomCommon tag=联通 headers, script-path=https://cdn.dreamyshare.com/surge/10010.js
...
[rewrite_local]
https:\/\/m\.client\.10010\.com\/(.*)\/smartwisdomCommon  url script-request-header https://cdn.dreamyshare.com/surge/10010.js

 */

const APIKey = 'Meijin_10010';
...
async function GetCookie() {
    ...
    if (cookie && cookie.indexOf('mobile') > -1) {
        // $.write(cookie, 'cookie');
    ...
    $.notify('中国联通','已更新cookie到qinglong');
//   }
    $.done();
}
