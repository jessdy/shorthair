...
===================
[Script]
京东组件 = type=http-request,pattern=https:\/\/api\.m\.jd\.com/client\.action,requires-body=1,max-size=0,script-path=https://cdn.dreamyshare.com/surge/jd.js,script-update-interval=0

===================
【Loon脚本配置】:
===================
[Script]
http-request https:\/\/api\.m\.jd\.com/client\.action tag=京东 headers, script-path=https://cdn.dreamyshare.com/surge/jd.js
...
[rewrite_local]
https:\/\/api\.m\.jd\.com/client\.action  url script-request-header https://cdn.dreamyshare.com/surge/jd.js
